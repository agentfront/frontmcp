/**
 * Sequential Stress Tests for Direct SDK Access (1000 iterations)
 *
 * Tests direct SDK operations under sustained sequential load
 */
import { perfTest, expect } from '@frontmcp/testing';

perfTest.describe('Direct Sequential Stress Testing', () => {
  perfTest.use({
