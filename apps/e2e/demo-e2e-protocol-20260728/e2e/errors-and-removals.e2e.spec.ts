...
import { INVALID_PARAMS, mcpStatelessFetch, METHOD_NOT_FOUND, PROTOCOL_20260728 } from './helpers/mcp-stateless-client';
...
test.describe('protocol 2026-07-28 — removals and error codes', () => {
  ...
  test('an unknown method still returns 404 + -32601', async ({ server }) => {
    const res = await mcpStatelessFetch(server.info.baseUrl, { method: 'totally/unknown', id: 701 });
