/**
 * Sequential Stress Tests for OpenAPI System (1000 iterations)
 *
 * Tests OpenAPI-generated tools under sustained sequential load
 */
import { perfTest, expect } from '@frontmcp/testing';

perfTest.describe('OpenAPI Sequential Stress Testing', () => {
  perfTest.use({
