...
- Add will/did/around phases to hook flows so servers can instrument execution without custom scaffolding.

### Fixed

- Reorganize core libraries to restore stable module resolution for adapters and plugins.
