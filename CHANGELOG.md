...
- Add `@mdx-js/mdx` dev dependency and limit doc formatting to `.mdx` files for Codex validation.

### CI

- Run `yarn install` in the Codex docs workflow and delete stale `docs/codex/v*` branches before creating release PRs.
