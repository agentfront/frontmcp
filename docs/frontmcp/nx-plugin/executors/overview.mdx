...
keywords: ['frontmcp', 'mcp', 'model context protocol', 'nx', 'monorepo', 'executor', 'build', 'task', 'typescript']
---
...
| [`build-exec`](/frontmcp/nx-plugin/executors/build-exec) | `frontmcp build --target node` | Yes       | No           |
