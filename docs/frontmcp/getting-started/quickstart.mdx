...
<Info>
**Choosing how to run FrontMCP?** See [Runtime Modes](/docs/frontmcp/deployment/runtime-modes) for a comparison of SDK, Server, and Serverless options.
</Info>

<CardGroup cols={2}>
  <Card title="Add Tools" icon="wrench" href="/docs/frontmcp/servers/tools">
    Learn how to create more powerful tools with validation, providers, and context
  </Card>

<Card title="OpenAPI Adapter" icon="file-code" href="/docs/frontmcp/guides/add-openapi-adapter">
  Auto-generate tools from your REST API's OpenAPI spec
</Card>

<Card title="Add Caching" icon="database" href="/docs/frontmcp/guides/caching-and-cache-miss">
  Improve performance with transparent caching
</Card>

<Card title="Authentication" icon="lock" href="/docs/frontmcp/authentication/overview">
  Secure your server with OAuth (local or remote)
</Card>

<Card title="Plugins" icon="puzzle-piece" href="/docs/frontmcp/extensibility/plugins">
  Add cross-cutting features like logging, metrics, and rate limiting
</Card>

  <Card title="Deploy" icon="cloud-arrow-up" href="/docs/frontmcp/deployment/production-build">
