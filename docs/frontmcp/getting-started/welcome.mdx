...
**Build something real**: jump to the [Quickstart](/docs/frontmcp/getting-started/quickstart) or set up your workspace in [Installation](/docs/frontmcp/getting-started/installation).
