...
- [ConfigPlugin](/docs/frontmcp/extensibility/config) - Full ConfigPlugin documentation
- [Environment Variables](/docs/frontmcp/extensibility/config#file-loading-behavior) - .env file loading
- [Schema Validation](/docs/frontmcp/extensibility/config#schema-validation) - Zod schema validation
