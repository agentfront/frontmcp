...
icon: "lightbulb"
keywords: ['frontmcp', 'mcp', 'model context protocol', 'sdk', 'reference', 'api', 'context', 'execution context', 'skill', 'typescript']
---
...
interface SkillContent {
  ...
  // Optional fields surfaced by dynamic skill providers
  rating?: number;
  category?: string;
