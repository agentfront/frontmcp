...
icon: "robot"
keywords: ['frontmcp', 'mcp', 'model context protocol', 'sdk', 'reference', 'api', 'decorators', 'typescript', 'agent']
---
...
<Note>
  ...
  creation. In browser environments, use the function-based `agent()` API:
