...
<CardGroup cols={2}>
  <Card title="RememberPlugin" icon="brain" href="/frontmcp/plugins/official/remember">
    Session memory for tools
  </Card>
  <Card title="CachePlugin" icon="database" href="/frontmcp/plugins/official/cache">
    Response caching
  </Card>
  <Card title="CodeCallPlugin" icon="code" href="/frontmcp/plugins/official/codecall">
