...
icon: "globe"
keywords: ['frontmcp', 'mcp', 'model context protocol', 'sdk', 'reference', 'api', 'core api', 'instance', 'server', '@FrontMcp', 'configuration', 'typescript']
---
...
interface HttpOptions {
  port?: number;                                   // default: PORT env var, else 3000
  ...
  cors?: CorsOptions | false;                      // CORS config (default: none; browsers block cross-origin reads)
