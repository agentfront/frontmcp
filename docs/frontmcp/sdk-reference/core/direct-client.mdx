---
title: "DirectClient"
description: "DirectClient provides programmatic access to FrontMCP servers with automatic tool formatting for different LLM platforms (OpenAI, Claude, Vercel AI, etc.)."
icon: "plug"
keywords: ['frontmcp', 'mcp', 'model context protocol', 'sdk', 'reference', 'api', 'core api', 'instance', 'direct client', 'embedded', 'typescript']
---
