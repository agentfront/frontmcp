...
icon: 'puzzle-piece'
keywords: ['frontmcp', 'mcp', 'model context protocol', 'plugin', 'plugins', 'extension', 'creating plugins', 'plugin development', 'typescript']
---
...
<Tip>
**Nx users:** Scaffold with `nx g @frontmcp/nx:plugin my-plugin --project my-app`. See [Plugin Generator](/frontmcp/nx-plugin/generators/plugin).
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Community" icon="users" href="https://github.com/agentfront/discussions">
