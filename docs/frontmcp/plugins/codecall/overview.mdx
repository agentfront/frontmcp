...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="book" href="/docs/frontmcp/plugins/codecall/api-reference">
  ...
  <Card title="Production Scaling" icon="server" href="/docs/frontmcp/plugins/codecall/scaling">
