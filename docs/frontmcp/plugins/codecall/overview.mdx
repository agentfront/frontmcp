...
icon: code
keywords: ['frontmcp', 'mcp', 'model context protocol', 'plugin', 'plugins', 'extension', 'codecall', 'agentscript', 'code execution', 'typescript']
---
...
<AccordionGroup>
  ...
  <Accordion title="Any LLM Support" icon="globe">
    ...
    - Open source models via custom adapters
    - Custom agents
...
<CardGroup cols={2}>
  <Card title="Source Code" icon="github" href="https://github.com/agentfront/tree/main/plugins/plugin-codecall">
