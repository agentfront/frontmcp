...
<CardGroup cols={2}>
  ...
  <Card title="Production &amp; Scaling" icon="server" href="/docs/frontmcp/plugins/codecall/production">
    Performance tuning and monitoring
  </Card>
  <Card title="AgentScript Guide" icon="scroll" href="/docs/frontmcp/plugins/codecall/agentscript">
