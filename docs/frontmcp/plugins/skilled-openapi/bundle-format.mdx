...
interface OperationDescriptor {
  ...
  requiredAuthorities?: AuthoritiesPolicy;      // optional per-op ABAC (AND-ed with skill-level)
  public?: boolean;                             // explicit "no auth required"; only consulted under unprotectedOps:'deny'
