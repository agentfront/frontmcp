...
| `outbound.allowPrivateNetworks`    | `boolean`                              | `false`                     | Bypass the **private-network** IP blocklist (RFC 1918 / loopback / CGNAT) for self-hosted on a private network. The **cloud-metadata / link-local denylist** (169.254.169.254, `fd00:ec2::254`, fe80::/10, …, in every IPv6 spelling such as `[::ffff:a9fe:a9fe]`) is **always enforced** regardless of this flag                                                                                                                                                    |
