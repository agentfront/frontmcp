...
<CardGroup cols={2}>
  <Card title="Source Code" icon="github" href="https://github.com/agentfront/tree/main/plugins/plugin-cache">
    View the cache plugin source code
  </Card>

<Card title="Demo Application" icon="code" href="https://github.com/agentfront/tree/main/apps/demo">
