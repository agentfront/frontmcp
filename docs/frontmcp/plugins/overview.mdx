...
<CardGroup cols={1}>
  ...
  <Card title="Feature Flags Plugin" icon="flag" href="/frontmcp/plugins/feature-flags-plugin">
    Gate tools, resources, prompts, and skills behind feature flags. Supports static flags, Split.io, LaunchDarkly,
    Unleash, and custom adapters.

    **Features:**
    - Declarative per-capability feature flag annotations
    - Automatic list filtering and execution gating
    - Programmatic flag checks via `this.featureFlags`
    - Multiple adapters: Static, Split.io, LaunchDarkly, Unleash, Custom
    - Context-scoped evaluation with caching

    **Best for:** Gradual rollouts, A/B testing, beta features, kill switches
...
| **Feature Flags** | Gradual rollouts, A/B testing | Low | Per-capability | Low    |
...
<CardGroup cols={2}>
  ...
  <Card title="Feature Flags Plugin" icon="flag" href="/frontmcp/plugins/feature-flags-plugin">
    Learn how to use feature flag-based capability gating
  </Card>
