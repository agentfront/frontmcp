...
<CardGroup cols={1}>
  <Card title="Remember Plugin" icon="brain" href="/docs/frontmcp/plugins/remember-plugin">
  ...
  <Card title="CodeCall Plugin" icon="code" href="/docs/frontmcp/plugins/codecall/overview">
    ...
    **Features:**
    ...
    - Defense-in-depth security with [Enclave](/docs/frontmcp/guides/enclave) (AST validation + runtime sandboxing)
...
<CardGroup cols={2}>
  <Card title="SDK Documentation" icon="book-open" href="/docs/frontmcp/getting-started/welcome">
...
<CardGroup cols={2}>
  <Card title="Enclave Guide" icon="shield-halved" href="/docs/frontmcp/guides/enclave">
    Learn about secure code execution with Enclave
  </Card>
  <Card title="AST Guard Guide" icon="shield-check" href="/docs/frontmcp/guides/ast-guard">
