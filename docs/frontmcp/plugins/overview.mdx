...
<Steps>
  ...
  <Step title="Join the Community">
    Visit the [FrontMCP Discussions](https://github.com/agentfront/discussions) to discover and share plugins.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="Submit Your Plugin" icon="plus" href="https://github.com/agentfront/discussions">
    Created a plugin? Share it with the community! Submit a PR to add your plugin to this page.
  </Card>

  <Card title="Plugin Template" icon="code-branch" href="https://github.com/agentfront/tree/main/libs/plugins">
...
<CardGroup cols={2}>
  ...
  <Card title="Source Code" icon="github" href="https://github.com/agentfront/tree/main/libs/plugins">
