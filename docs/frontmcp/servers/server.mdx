...
| Value          | Behavior                                                                                   |
| -------------- | ------------------------------------------------------------------------------------------ |
| `undefined`    | **Default** — permissive CORS enabled (`origin: true`, `credentials: true`)                |
...
@FrontMcp({
  http: { port: 3001 },
  // cors is undefined → permissive CORS (origin: true, credentials: true)
})
```
