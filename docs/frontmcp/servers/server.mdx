...
@FrontMcp({
  ...
  http?: {
    ...
    cors?: CorsOptions | false, // default: no CORS headers (same-origin only)
  },
...
| Value         | Behavior                                                                                        |
| ------------- | ----------------------------------------------------------------------------------------------- |
| `undefined`   | **Default** — no CORS headers are sent; a browser will not let another origin read the response |
