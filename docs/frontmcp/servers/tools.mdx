...
<Tip>
  ...
  See [Request Context](/docs/frontmcp/extensibility/request-context) for complete API reference.
</Tip>
...
<CardGroup cols={2}>
  <Card title="Tool UI Guide" icon="palette" href="/docs/frontmcp/ui/integration/tools">
    Complete configuration options and examples
  </Card>
  <Card title="UI Components" icon="puzzle-piece" href="/docs/frontmcp/ui/components/overview">
  ...
  <Card title="Testing UI" icon="flask-vial" href="/docs/frontmcp/ui/integration/testing">
