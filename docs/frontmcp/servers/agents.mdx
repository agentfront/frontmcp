---
title: Agents
description: AI agents as MCP tools with the @Agent decorator and typed conversation state
slug: servers/agents
icon: robot
keywords: ['frontmcp', 'mcp', 'model context protocol', 'mcp server', 'server', 'components', 'agents', '@Agent', 'agent', 'typescript']
---
...
<Tip>
**Nx users:** Scaffold with `nx g @frontmcp/nx:agent my-agent --project my-app`. See [Agent Generator](/frontmcp/nx-plugin/generators/agent).
</Tip>
...
See [Environment Awareness](/frontmcp/features/environment-awareness) for the full reference.
