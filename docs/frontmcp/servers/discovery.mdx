...
<Note>
See [Prompts](/docs/frontmcp/servers/prompts) and [Resources](/docs/frontmcp/servers/resources) for authoring guidance. This page focuses on the MCP wire format and runtime behavior.
</Note>
