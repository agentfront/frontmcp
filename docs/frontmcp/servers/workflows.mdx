---
title: Workflows
description: Long-running multi-step workflows with state, retries, and resumability
slug: servers/workflows
icon: diagram-project
keywords: ['frontmcp', 'mcp', 'model context protocol', 'mcp server', 'server', 'components', 'workflows', '@Workflow', 'typescript']
---
...
<Tip>
**Nx users:** Scaffold with `nx g @frontmcp/nx:workflow my-workflow --project my-app`. See [Workflow Generator](/frontmcp/nx-plugin/generators/workflow).
</Tip>
...
| `hideFromDiscovery` | `boolean`                          | `false`    | Hide from `list_workflows`                          |
| `permissions`       | `JobPermission[]`                  | —          | RBAC permission rules (same shape and semantics as [job permissions](/frontmcp/servers/jobs#permissions)) |
...
| Trigger   | Description                                               |
| --------- | --------------------------------------------------------- |
| `manual`  | Triggered via `execute_workflow` tool or DirectClient     |
...
| Tool                  | Description                                                        |
| --------------------- | ------------------------------------------------------------------ |
| `list_workflows`      | List registered workflows with optional filtering                  |
| `execute_workflow`    | Execute a workflow (inline or background)                          |
