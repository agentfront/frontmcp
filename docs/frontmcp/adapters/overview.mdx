...
<CardGroup cols={1}>
  <Card title="OpenAPI Adapter" icon="code" href="/docs/frontmcp/adapters/openapi-adapter">
...
<CardGroup cols={3}>
  <Card title="OpenAPI Adapter" icon="book" href="/docs/frontmcp/adapters/openapi-adapter">
