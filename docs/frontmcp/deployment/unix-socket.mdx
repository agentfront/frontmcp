...
keywords: ['frontmcp', 'mcp', 'model context protocol', 'deployment', 'production', 'hosting', 'unix socket', 'ipc', 'typescript']
---
...
| ---------------------- | --------- | ---------- | ----------------------------------------------------- |
| `path`                 | `string`  | _required_ | Path to the `.sqlite` database file                   |
