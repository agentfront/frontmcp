...
<CardGroup cols={2}>
  <Card title="Serverless Deployment" icon="cloud" href="/docs/frontmcp/deployment/serverless">
  ...
  <Card title="Cache Plugin" icon="bolt" href="/docs/frontmcp/plugins/cache-plugin">
    Add caching to your tools and resources
  </Card>
  <Card title="Production Deployment" icon="rocket" href="/docs/frontmcp/deployment/production-build">
