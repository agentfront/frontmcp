...
| **ESM Dynamic Loading** | In-memory cache mode, Blob URL module evaluation via `loadFrom()`     |
...
The [`loadFrom()`](/frontmcp/servers/esm-packages) API works in browser environments with these differences:
