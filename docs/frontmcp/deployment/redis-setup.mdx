...
<Tip>
**Deploying to Vercel?** Consider [Vercel KV](/docs/frontmcp/deployment/vercel-kv) for edge-compatible storage without managing Redis infrastructure.
</Tip>
...
For complete CachePlugin API documentation, see the [Cache Plugin Guide](/docs/frontmcp/plugins/cache-plugin).
