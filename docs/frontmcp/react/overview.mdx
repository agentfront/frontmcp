...
```bash npm
npm install @frontmcp/react @frontmcp/sdk @frontmcp/utils react react-dom
```

```bash pnpm
pnpm add @frontmcp/react @frontmcp/sdk @frontmcp/utils react react-dom
```

```bash yarn
yarn add @frontmcp/react @frontmcp/sdk @frontmcp/utils react react-dom
```
...
| `@frontmcp/sdk` | `>=0.12.0` | Yes |
| `@frontmcp/utils` | `>=0.12.0` | Yes |
