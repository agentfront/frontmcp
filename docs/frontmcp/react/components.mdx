...
These components are deprecated. Use `mcpComponent()` instead — see [Agent Components](/frontmcp/react/agent-components#agentcontent) for full details, props, and migration.
