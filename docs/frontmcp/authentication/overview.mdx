...
<CardGroup cols={2}>
  <Card title="Authorization Modes" icon="layer-group" href="/docs/frontmcp/authentication/modes">
    Deep dive into public, transparent, and orchestrated modes
  </Card>
  <Card title="Token & Sessions" icon="key" href="/docs/frontmcp/authentication/token">
