...
<CardGroup cols={2}>
  <Card title="Remote Proxy" icon="share" href="/docs/frontmcp/authentication/remote-proxy">
    Handle IdPs without DCR support
  </Card>
  <Card title="Progressive Authorization" icon="forward" href="/docs/frontmcp/authentication/progressive">
    Implement incremental app authorization
  </Card>
  <Card title="Local OAuth" icon="server" href="/docs/frontmcp/authentication/local">
    Built-in OAuth server setup
  </Card>
  <Card title="Production Checklist" icon="clipboard-check" href="/docs/frontmcp/authentication/production">
