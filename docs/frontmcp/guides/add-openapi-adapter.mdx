...
- A FrontMCP project initialized ([see Installation](/docs/frontmcp/getting-started/installation))
...
<Tip>
  For comprehensive documentation on all configuration options including `inputTransforms`, `toolTransforms`, `descriptionMode`, and the `x-frontmcp` OpenAPI extension, see the [full OpenAPI Adapter documentation](/docs/frontmcp/adapters/openapi-adapter).
</Tip>
...
<CardGroup cols={2}>
  <Card title="Full OpenAPI Adapter Docs" icon="book" href="/docs/frontmcp/adapters/openapi-adapter">
    Explore all configuration options and advanced features
  </Card>

<Card title="Authentication Setup" icon="lock" href="/docs/frontmcp/servers/authentication/overview">
  Learn how to configure authentication for your APIs
</Card>

<Card title="Plugin System" icon="puzzle-piece" href="/docs/frontmcp/servers/extensibility/plugins">
