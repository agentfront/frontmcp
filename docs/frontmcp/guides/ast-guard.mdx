...
The AgentScript preset is purpose-built for validating LLM-generated orchestration code. It's the default preset used by [Enclave](/docs/frontmcp/guides/enclave) and the [CodeCall Plugin](/docs/frontmcp/plugins/codecall/overview).
