...
description: Step-by-step guide to building a real-world FrontMCP plugin from scratch
sidebarTitle: Create a Plugin
slug: guides/create-plugin
icon: plug
keywords: ['frontmcp', 'mcp', 'model context protocol', 'guide', 'tutorial', 'how-to', 'create plugin', 'plugin tutorial', 'typescript']
---
...
<CardGroup cols={2}>
  ...
  <Card title="Plugin Reference" icon="book" href="/frontmcp/plugins/overview">
