...
<Note>
  Enclave is used internally by the [CodeCall Plugin](/docs/frontmcp/plugins/codecall-plugin) to execute JavaScript execution plans. You can also use it directly for custom use cases.
</Note>
...
The [CodeCall Plugin](/docs/frontmcp/plugins/codecall-plugin) uses Enclave internally:
...
<CardGroup cols={2}>
  ...
  <Card title="CodeCall Plugin" icon="code" href="/docs/frontmcp/plugins/codecall-plugin">
