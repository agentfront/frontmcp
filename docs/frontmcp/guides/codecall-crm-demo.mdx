...
<Tip>
Pair this demo with the [platform-aware UI guide](/docs/frontmcp/guides/ui-library) to style consent and troubleshooting screens, and mirror the automated coverage in `apps/e2e/demo-e2e-codecall/e2e/codecall.e2e.test.ts`.
</Tip>
