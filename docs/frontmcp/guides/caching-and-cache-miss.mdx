...
<CardGroup cols={3}>
  <Card title="Cache Plugin Docs" icon="book" href="/docs/frontmcp/plugins/cache-plugin">
    Full Cache Plugin reference documentation
  </Card>

  <Card title="Custom Hooks" icon="link" href="/docs/frontmcp/guides/customize-flow-stages">
    Learn how the cache plugin uses hooks internally
  </Card>

  <Card title="Plugin Development" icon="puzzle-piece" href="/docs/frontmcp/servers/extensibility/plugins">
