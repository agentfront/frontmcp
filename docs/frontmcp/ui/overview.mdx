...
<CardGroup cols={2}>
  ...
  <Card title="OpenAI Resource Widgets" icon="panel-right" href="/docs/frontmcp/ui/components/resource-widgets">
...
<CardGroup cols={2}>
  <Card title="Getting Started" icon="rocket-launch" href="/docs/frontmcp/ui/getting-started">
    Build your first widget in minutes
  </Card>
  <Card title="Components" icon="grid-2" href="/docs/frontmcp/ui/components/overview">
    Explore the component library
  </Card>
  <Card title="Templates" icon="code" href="/docs/frontmcp/ui/templates/overview">
    Learn about HTML, React, and MDX templates
  </Card>
  <Card title="Theming" icon="paintbrush" href="/docs/frontmcp/ui/theming/overview">
