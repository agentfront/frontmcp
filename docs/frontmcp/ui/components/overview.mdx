...
<CardGroup cols={2}>
  <Card title="Button" icon="hand-pointer" href="/frontmcp/ui/components/button">
    Versatile buttons with variants, sizes, loading states, and HTMX support
  </Card>
  <Card title="Card" icon="square" href="/frontmcp/ui/components/card">
    Content containers with headers, footers, and multiple styles
  </Card>
  <Card title="Badge" icon="tag" href="/frontmcp/ui/components/badge">
    Status indicators, labels, and dot notifications
  </Card>
  <Card title="Alert" icon="bell" href="/frontmcp/ui/components/alert">
    Info, success, warning, and error messages with dismiss support
  </Card>
  <Card title="Form" icon="rectangle-list" href="/frontmcp/ui/components/form">
    Inputs, selects, textareas, checkboxes, and form layouts
  </Card>
  <Card title="Table" icon="table" href="/frontmcp/ui/components/table">
    Data tables with headers, rows, and styling options
  </Card>
  <Card title="List" icon="list" href="/frontmcp/ui/components/list">
    Description lists and action lists for structured content
  </Card>
  <Card title="Avatar" icon="user" href="/frontmcp/ui/components/avatar">
    User avatars with images, initials, and status indicators
  </Card>
  <Card title="Modal" icon="window-maximize" href="/frontmcp/ui/components/modal">
    Dialogs and drawers for overlay content
  </Card>
  <Card title="Resource Widgets" icon="panel-right" href="/frontmcp/ui/components/resource-widgets">
