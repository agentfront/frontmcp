...
<CardGroup cols={2}>
  <Card title="Customization" icon="sliders" href="/docs/frontmcp/ui/theming/customization">
    Create custom themes
  </Card>
  <Card title="Dark Mode" icon="moon" href="/docs/frontmcp/ui/theming/dark-mode">
