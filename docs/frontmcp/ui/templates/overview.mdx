...
<CardGroup cols={2}>
  <Card title="HTML Templates" icon="file-code" href="/docs/frontmcp/ui/templates/html">
    String-based templates with helpers
  </Card>
  <Card title="React Templates" icon="react" href="/docs/frontmcp/ui/templates/react">
    Full React component support
  </Card>
  <Card title="MDX Templates" icon="markdown" href="/docs/frontmcp/ui/templates/mdx">
    Markdown with embedded JSX
  </Card>
  <Card title="Custom Templates" icon="gear" href="/docs/frontmcp/ui/templates/custom">
