...
<Columns cols={2}>
  <Card title="Test Fixtures" icon="puzzle-piece" href="/docs/frontmcp/testing/fixtures">
    Deep dive into the fixture system and available APIs
  </Card>
  <Card title="Custom Matchers" icon="check-double" href="/docs/frontmcp/testing/matchers">
    Full reference for all MCP-specific Jest matchers
  </Card>
  <Card title="Auth Testing" icon="key" href="/docs/frontmcp/testing/authentication">
    Test authentication flows with token generation
  </Card>
  <Card title="HTTP Mocking" icon="globe" href="/docs/frontmcp/testing/http-mocking">
