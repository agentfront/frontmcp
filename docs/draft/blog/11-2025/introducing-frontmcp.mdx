...
<img noZoom className="blog-full-image light-img" src="../../assets/logo/banner.light.png" />
<img noZoom className="blog-full-image dark-img" src="../../assets/logo/banner.dark.png" />
...
- 📚 **Docs**: [`/docs`](/docs/getting-started/welcome) for the latest 0.3 series ([FrontMCP][2])
