...
icon: palette
description: Rich visual widgets for MCP tool responses
---

# FrontMCP UI

`@frontmcp/ui` is a platform-agnostic component library for building rich HTML widgets that display alongside AI tool responses. Transform plain text outputs into interactive, visually appealing interfaces.
