...
```typescript
import { avatar, avatarGroup } from '@frontmcp/uipack/components';
```
...
```typescript
import { card, avatar, avatarGroup, badge } from '@frontmcp/uipack/components';
...
```typescript
import { actionList, avatar } from '@frontmcp/uipack/components';
