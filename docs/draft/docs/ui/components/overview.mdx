...
<CardGroup cols={2}>
  ...
  <Card title="Resource Widget" icon="folder-open" href="/docs/ui/components/resource-widget">
    Cards, lists, and preview helpers for documents, tickets, and tool outputs
  </Card>
</CardGroup>
...
<Info>
  Escape user input before passing it to the component helpers, especially for Tool UI templates that run inside AI clients.
</Info>
