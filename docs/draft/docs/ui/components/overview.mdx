...
HTML string components are in the `@frontmcp/uipack` package:
...
```typescript
import { componentName } from '@frontmcp/uipack/components';
...
```typescript
import { button, buttonGroup, card, cardGroup, badge, badgeGroup } from '@frontmcp/uipack/components';
