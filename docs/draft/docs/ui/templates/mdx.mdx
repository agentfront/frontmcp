...
sidebarTitle: MDX
icon: markdown
description: Markdown with embedded JSX for content-focused widgets
---

# MDX Templates

MDX combines Markdown with JSX, letting you write content in Markdown while embedding React components. It's ideal for documentation-style widgets and content-heavy displays.
