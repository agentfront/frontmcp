...
sidebarTitle: HTML
icon: file-code
description: String-based templates for simple widgets
---

# HTML Templates

HTML templates are functions that return HTML strings. They're the simplest and most performant option for tool widgets.
