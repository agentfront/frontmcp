...
icon: code
description: HTML, React, and MDX templates for tool widgets
---

# Template Types

FrontMCP UI supports three template types for building tool widgets. Each type is **auto-detected** based on your template definition - no configuration needed.
...
For client-side interactivity, see [Hydration](/docs/ui/advanced/hydration).

## Next Steps

<CardGroup cols={2}>
  <Card title="HTML Templates" icon="file-code" href="/docs/ui/templates/html">
    String-based templates with helpers
  </Card>
  <Card title="React Templates" icon="react" href="/docs/ui/templates/react">
    Full React component support
  </Card>
  <Card title="MDX Templates" icon="markdown" href="/docs/ui/templates/mdx">
    Markdown with embedded JSX
  </Card>
  <Card title="Custom Templates" icon="gear" href="/docs/ui/templates/custom">
