...
```typescript
import { detailLayout } from '@frontmcp/ui/layouts';
...
```typescript
import { listLayout } from '@frontmcp/ui/layouts';
...
```typescript
import { formLayout } from '@frontmcp/ui/layouts';
...
```typescript
import { emptyStateLayout } from '@frontmcp/ui/layouts';
...
```typescript
import { errorLayout } from '@frontmcp/ui/layouts';
...
```typescript
import { successLayout } from '@frontmcp/ui/layouts';
...
import { card, badge, button, escapeHtml } from '@frontmcp/ui/components';
