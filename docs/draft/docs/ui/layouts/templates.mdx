...
```typescript
import { dashboardLayout } from '@frontmcp/uipack/components';
...
```typescript
import { detailLayout } from '@frontmcp/uipack/components';
...
```typescript
import { listLayout } from '@frontmcp/uipack/components';
...
```typescript
import { formLayout } from '@frontmcp/uipack/components';
...
```typescript
import { emptyStateLayout } from '@frontmcp/uipack/components';
...
```typescript
import { errorLayout } from '@frontmcp/uipack/components';
...
```typescript
import { successLayout } from '@frontmcp/uipack/components';
...
import { baseLayout, card, badge, button, escapeHtml } from '@frontmcp/uipack/components';
import { ThemeConfig } from '@frontmcp/uipack/components';
