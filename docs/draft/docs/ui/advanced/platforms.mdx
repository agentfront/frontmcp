...
```typescript
import { getPlatform, OPENAI_PLATFORM, CLAUDE_PLATFORM } from '@frontmcp/uipack/components';
...
```typescript
import { OPENAI_PLATFORM } from '@frontmcp/uipack/components';
...
```typescript
import { CLAUDE_PLATFORM } from '@frontmcp/uipack/components';
...
```typescript
import { baseLayout, fetchAndCacheScriptsFromTheme } from '@frontmcp/uipack/components';
...
```typescript
import { GEMINI_PLATFORM } from '@frontmcp/uipack/components';
...
```typescript
import { getPlatform, canUseCdn, needsInlineScripts } from '@frontmcp/uipack/components';
...
```typescript
import { supportsFullInteractivity, getFallbackMode } from '@frontmcp/uipack/components';
...
```typescript
import { createPlatform } from '@frontmcp/uipack/components';
