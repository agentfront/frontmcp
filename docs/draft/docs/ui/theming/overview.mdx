...
```typescript
import { baseLayout, DEFAULT_THEME } from '@frontmcp/uipack/components';
...
<CardGroup cols={2}>
  <Card title="Customization" icon="sliders" href="/docs/ui/theming/customization">
    Create custom themes
  </Card>
  <Card title="Dark Mode" icon="moon" href="/docs/ui/theming/dark-mode">
