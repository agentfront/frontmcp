...
<CardGroup cols={2}>
  <Card title="Local Dev Server" icon="computer" href="/docs/deployment/local-dev-server">
    Run and test your FrontMCP server locally
  </Card>

  <Card title="Production Build" icon="hammer" href="/docs/deployment/production-build">
