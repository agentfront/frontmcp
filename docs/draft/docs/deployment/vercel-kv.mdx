...
<Steps>
  ...
  <Step title="Deploy">
    ...
    ```
    <Info>
      Build once locally, then use `vercel deploy --prebuilt` to publish the `.vercel/output` folder without triggering another Vercel build.
    </Info>
  </Step>
</Steps>
