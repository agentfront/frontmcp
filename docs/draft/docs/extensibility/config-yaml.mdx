...
class MyTool extends ToolContext {
  async execute() {
    return {
      ...
      darkMode: this.config.get('features.darkMode'),
    };
  }
}
...
- [ConfigPlugin](/docs/extensibility/config) - Full ConfigPlugin documentation
- [Environment Variables](/docs/extensibility/config#file-loading-behavior) - .env file loading
- [Schema Validation](/docs/extensibility/config#schema-validation) - Zod schema validation
