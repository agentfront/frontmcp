...
<CardGroup cols={1}>
  ...
  <Card title="Dashboard Plugin" icon="chart-network" href="/docs/plugins/dashboard-plugin">
    Visualize your MCP server with live telemetry, graph views, and built-in introspection tools.

    **Features:**
    - Live SSE streams for logs, traffic, and metrics
    - Graph exploration of servers, scopes, tools, resources, and prompts
    - Built-in tools to list metadata and export the server graph
    - Secure optional token-based access and CDN overrides
    - Standalone DashboardApp/HTTP plugin for dedicated consoles

    **Best for:** Observability, debugging, and platform monitoring
...
| **Dashboard** | Visual monitoring & telemetry | Low      | Server-wide  | Medium      |
...
<CardGroup cols={2}>
  ...
  <Card title="Dashboard Plugin" icon="view-columns" href="/docs/plugins/dashboard-plugin">
    Explore your server graph, logs, and tools from a single UI.
  </Card>
