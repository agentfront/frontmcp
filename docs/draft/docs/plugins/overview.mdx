...
<CardGroup cols={1}>
  ...
  <Card title="Dashboard Plugin" icon="monitor" href="/docs/plugins/dashboard">
    Visualize your MCP server graph, tool metadata, and scopes through the streaming DashboardApp or plugin.
  </Card>
</CardGroup>
...
| **Dashboard** | Real-time server graph & telemetry | Low      | Server       | Low         |
...
<CardGroup cols={2}>
  ...
  <Card title="Dashboard Plugin" icon="monitor" href="/docs/plugins/dashboard">
    Explore the DashboardApp and plugin for live visualization of tools, apps, and resources.
  </Card>
