...
<CardGroup cols={2}>
  <Card title="Local OAuth" icon="key" href="/docs/authentication/local">
  ...
  <Card title="Progressive Authorization" icon="layer-group" href="/docs/authentication/progressive">
    Enable incremental authorization for tool-by-tool access control
  </Card>
  <Card title="Production Checklist" icon="shield-check" href="/docs/authentication/production">
