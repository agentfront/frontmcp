...
**Build something real**: jump to the [Quickstart](/docs/getting-started/quickstart) or set up your workspace in [Installation](/docs/getting-started/installation).
