...
sidebarTitle: Theme
icon: paintbrush
description: Complete API reference for the @frontmcp/uipack theme system. The theme system provides comprehensive control over colors, typography, spacing, and external resources.
---
...
```typescript
import { mergeThemes, DEFAULT_THEME } from '@frontmcp/uipack/theme';
...
```typescript
import { buildFontPreconnect } from '@frontmcp/uipack/theme';
...
```typescript
import { buildFontStylesheets } from '@frontmcp/uipack/theme';
...
```typescript
import { buildCdnScripts } from '@frontmcp/uipack/theme';
...
```typescript
import { fetchAndCacheScriptsFromTheme, DEFAULT_THEME } from '@frontmcp/uipack/theme';
...
```typescript
import { canUseCdn, getPlatform } from '@frontmcp/uipack/theme';
...
```typescript
import { needsInlineScripts, getPlatform } from '@frontmcp/uipack/theme';
...
```typescript
import { createTheme, buildStyleBlock, buildCdnScripts } from '@frontmcp/uipack/theme';
