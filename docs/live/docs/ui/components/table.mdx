...
```typescript
import { table, tableRow, tableCell, tableHeader } from '@frontmcp/ui/components';
```
...
```typescript
import { table, badge, button } from '@frontmcp/ui/components';
...
```typescript
import { card, table, badge, button, input } from '@frontmcp/ui/components';
