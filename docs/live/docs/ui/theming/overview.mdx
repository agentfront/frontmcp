...
FrontMCP UI includes a comprehensive theming system for customizing the appearance of your widgets. The default theme uses a GitHub/OpenAI-inspired gray-black aesthetic.
