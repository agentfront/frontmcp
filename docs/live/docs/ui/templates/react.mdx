...
sidebarTitle: React
icon: react
description: Full React component support for complex UIs
---

# React Templates

React templates let you build tool widgets using JSX components. They support full React features including hooks, context, and TypeScript.
