...
icon: shield-check
description: Zod schema validation for component inputs
---

# Validation

FrontMCP UI uses Zod schemas to validate component options at runtime. Invalid inputs render a styled error box instead of crashing.
