...
<CardGroup cols={2}>
  ...
  <Card title="Enclave Library" icon="shield" href="https://github.com/agentfront/enclave/tree/main/libs/enclave">
    Sandbox execution engine
  </Card>
  <Card title="AST Guard" icon="lock" href="https://github.com/agentfront/enclave/tree/main/libs/ast-guard">
