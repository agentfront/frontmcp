<!-- frontmcp:skills-start v1.0.4 -->

# Skills and Tools

> Auto-generated by `frontmcp skills install` (v1.0.4) — do not edit manually.
...
#### frontmcp (published as `frontmcp` on npm, internal monorepo name `@frontmcp/cli`)
