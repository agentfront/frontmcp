...
export type Protocol2026Version = typeof PROTOCOL_2026_07_28;
 ...
 */
export const MCP_2026_RETIRED_ERROR_CODES = [-32002, -32042] as const;

/** Methods this revision removed from the core protocol. */
export const MCP_2026_REMOVED_METHODS = [
  'initialize',
...
export const MCP_2026_ADDED_METHODS = ['server/discover', 'subscriptions/listen'] as const;
...
export interface RequestMeta2026 {
  progressToken?: string | number;
  [MCP_2026_META.protocolVersion]: string;
  [MCP_2026_META.clientInfo]?: Implementation;
  [MCP_2026_META.clientCapabilities]: ClientCapabilities2026;
  [MCP_2026_META.logLevel]?: LoggingLevel;
  [key: string]: unknown;
}

export interface ResultMeta2026 {
  [MCP_2026_META.serverInfo]?: Implementation;
  [key: string]: unknown;
}

export interface NotificationMeta2026 {
  [MCP_2026_META.subscriptionId]?: RequestId;
  [key: string]: unknown;
}

export interface Result2026 {
  _meta?: ResultMeta2026;
 ...
 */
export interface CacheableResult extends Result2026 {
...
export interface ClientCapabilities2026 {
...
export interface ServerCapabilities2026 {
  experimental?: Record<string, Record<string, unknown>>;
  /** @deprecated Deprecated in 2026-07-28 (SEP-2577). */
...
export interface DiscoverResult extends CacheableResult {
  ...
  capabilities: ServerCapabilities2026;
  instructions?: string;
}
 ...
 */
export interface InputRequiredResult extends Result2026 {
...
export function isProtocol2026(version: unknown): version is Protocol2026Version {
...
export function readDeclaredProtocolVersion(body: unknown): string | undefined {
  ...
  const declared = params?._meta?.[MCP_2026_META.protocolVersion];
