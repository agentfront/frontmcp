...
import {
  ...
  FrontMcpAuth,
  AuthProviderType,
  Token, AuthProviderEntry, AuthRegistryInterface, AuthProviderRecord, AuthProviderKind,
} from '@frontmcp/sdk';
...
export class AuthRegistry extends RegistryAbstract<AuthProviderEntry, AuthProviderRecord, AuthProviderType[]> implements AuthRegistryInterface {
  ...
  constructor(providers: ProviderRegistry, metadata: AuthProviderType[], primary?: AuthOptions) {
