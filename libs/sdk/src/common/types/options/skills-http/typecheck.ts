...
import type { SkillsConfigOptions } from './interfaces';

type IsAssignable<T, U> = T extends U ? true : false;
type AssertTrue<T extends true> = T;

type _SkillsSchemaInput = z.input<typeof skillsConfigOptionsSchema>;
type _SkillsInterfaceCheck = AssertTrue<IsAssignable<SkillsConfigOptions, _SkillsSchemaInput>>;

type _SchemaKeys = keyof _SkillsSchemaInput;
type _InterfaceKeys = keyof SkillsConfigOptions;
