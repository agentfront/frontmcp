 ...
 */
import { MCP_2026_META, SUBSCRIPTIONS_ACKNOWLEDGED_METHOD, type SubscriptionFilter } from '@frontmcp/protocol';
    ...
    try {
      ...
      yield frame({
        ...
        params: {
          ...
          _meta: { [MCP_2026_META.subscriptionId]: subscriptionId },
        },
      });
