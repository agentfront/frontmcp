...
describe('ReferenceResolver', () => {
  ...
  describe('predictExpandedSize', () => {
    ...
    it('should calculate size of nested objects', () => {
      ...
      expect(size).toBe(
        Buffer.byteLength('data1') +
          Buffer.byteLength('data2') +
          Buffer.byteLength('plain string'),
      );
    });
    ...
    it('should calculate size of arrays', () => {
      ...
      expect(size).toBe(
        Buffer.byteLength('item1') +
          Buffer.byteLength('item2') +
          Buffer.byteLength('plain'),
      );
    });
    ...
    it('should throw on excessive depth', () => {
      ...
      expect(() => strictResolver.predictExpandedSize(deepObject)).toThrow(
        ResolutionLimitError,
      );
    });
  });
  ...
  describe('resolve', () => {
    ...
    it('should throw for unknown reference IDs', () => {
      expect(() =>
        resolver.resolve('__REF_00000000-0000-0000-0000-000000000000__'),
  ...
  describe('createComposite', () => {
    ...
    it('should throw when composites not allowed', () => {
      ...
      expect(() => strictResolver.createComposite([ref, '-suffix'])).toThrow(
        /Cannot concatenate reference IDs/,
      );
