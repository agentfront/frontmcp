 ...
 */
export function detectTemplateMode(template: unknown): TemplateMode {
 ...
 */
export function detectFormatFromPath(pathOrUrl: string): TemplateFormat {
  ...
  // Default to HTML for .html or unknown extensions
  return 'html';
}
